...
const getBackendURL = () => {
  ...
  if (currentDomain === 'localhost' || currentDomain === '127.0.0.1') {
    ...
    // Preview domain - use environment variable if set, otherwise use same domain
    return process.env.REACT_APP_BACKEND_URL || `${window.location.protocol}//${window.location.host}`;
  } else {
