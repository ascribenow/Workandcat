                  ...
                  <div className="border rounded-lg p-6 mb-8" style={{ backgroundColor: '#fafafa', borderColor: '#e5e7eb' }}>
                    ...
                    <div className="border rounded-lg p-4 mb-6" style={{ backgroundColor: '#f7fdf0', borderColor: '#9ac026' }}>
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          <h4 className="text-sm font-medium" style={{ color: '#545454', fontFamily: 'Manrope, sans-serif' }}>LLM Auto-Generation</h4>
                          <p className="text-sm mt-1" style={{ color: '#545454', fontFamily: 'Lato, sans-serif' }}>
