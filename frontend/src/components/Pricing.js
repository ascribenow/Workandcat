      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center">
                ...
                <span className="text-left" style={{ color: '#545454', fontFamily: 'Lato, sans-serif' }}>
                  Start with 10 adaptive sessions
                </span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-[#9ac026] mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-left" style={{ color: '#545454', fontFamily: 'Lato, sans-serif' }}>
                  Continue with 4 adaptive sessions per week
                </span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-[#9ac026] mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center">
                ...
                <span className="text-left" style={{ color: '#545454', fontFamily: 'Lato, sans-serif' }}>
                  <span className="italic">Ask Twelvr</span>: Chat real time with our AI doubt resolution engine
                </span>
              </div>
            </div>
          ...
          <div className={`bg-white border-2 rounded-2xl p-8 text-center hover:border-[#9ac026] transition-colors ${
            highlightedPlan === PLAN_TYPES.PRO_REGULAR ? 'border-[#9ac026] ring-2 ring-[#9ac026] ring-opacity-20' : 'border-gray-200'
          }`}>
            <div className="mb-6">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center">
                ...
                <span className="text-left italic" style={{ color: '#545454', fontFamily: 'Lato, sans-serif' }}>
          ...
          <div className={`bg-white border-2 rounded-2xl p-8 text-center relative shadow-lg transform scale-105 ${
            ...
            <div className="mb-8">
              <div className="flex items-baseline justify-center mb-2">
                <span className="text-5xl font-bold" style={{ color: '#545454' }}>₹1,499</span>
              </div>
              <p className="text-gray-600" style={{ fontFamily: 'Lato, sans-serif' }}>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <p style={{ color: '#545454', fontFamily: 'Lato, sans-serif' }}>
                Get 10 complete sessions to experience our adaptive system. No credit card required, no time limits, just 10 high-quality prep sessions to see how Twelvr works for you.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <p style={{ color: '#545454', fontFamily: 'Lato, sans-serif' }}>
                Pro Regular gives you 30 days of unlimited sessions, perfect for focused monthly prep cycles. Pro Exclusive extends till Dec 31, 2025 23:59 IST with unlimited sessions for long-term CAT preparation. Both plans include Ask Twelvr for real-time doubt resolution. Pro Regular will be available from January 1, 2026.
              </p>
            </div>
