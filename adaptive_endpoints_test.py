...
API BASE: Test both https://catprep-repair.preview.emergentagent.com and https://adaptive-quant.emergent.host
...
def main():
    ...
    api_bases = [
        "https://catprep-repair.preview.emergentagent.com/api",
