...
API BASE: Test both https://cat-session-sys.preview.emergentagent.com and https://adaptive-quant.emergent.host
...
def main():
    ...
    api_bases = [
        "https://cat-session-sys.preview.emergentagent.com/api",
