...
API BASE: Test both https://learn-twelvr.preview.emergentagent.com and https://adaptive-quant.emergent.host
...
def main():
    ...
    api_bases = [
        "https://learn-twelvr.preview.emergentagent.com/api",
