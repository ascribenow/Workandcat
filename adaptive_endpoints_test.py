...
API BASE: Test both https://adapt-engine-1.preview.emergentagent.com and https://adaptive-quant.emergent.host
...
def main():
    ...
    api_bases = [
        "https://adapt-engine-1.preview.emergentagent.com/api",
