...
API BASE: Test both https://catprep-adapt.preview.emergentagent.com and https://adaptive-quant.emergent.host
...
def main():
    ...
    api_bases = [
        "https://catprep-adapt.preview.emergentagent.com/api",
