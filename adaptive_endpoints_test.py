...
API BASE: Test both https://twelvr-auth-fix.preview.emergentagent.com and https://adaptive-quant.emergent.host
...
def main():
    ...
    api_bases = [
        "https://twelvr-auth-fix.preview.emergentagent.com/api",
