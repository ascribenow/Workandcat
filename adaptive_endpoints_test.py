...
API BASE: Test both https://twelvr-adaptive-2.preview.emergentagent.com and https://adaptive-quant.emergent.host
...
def main():
    ...
    api_bases = [
        "https://twelvr-adaptive-2.preview.emergentagent.com/api",
