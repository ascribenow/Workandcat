...
API BASE: Test both https://llm-prompt-repair.preview.emergentagent.com and https://adaptive-quant.emergent.host
...
def main():
    ...
    api_bases = [
        "https://llm-prompt-repair.preview.emergentagent.com/api",
