...
API BASE: Test both https://adaptive-insights-1.preview.emergentagent.com and https://adaptive-quant.emergent.host
...
def main():
    ...
    api_bases = [
        "https://adaptive-insights-1.preview.emergentagent.com/api",
