    ...
    try:
        ...
        try:
            ...
            try:
                ...
                # Apply LLM-generated enrichment data (EXCLUDING locked pedagogy fields)
                # TWELVR NEW VERSION: Only enrich non-pedagogy fields
                
                # Only update answer if it's empty or was generated by LLM
                ...
                # DO NOT UPDATE: solution_approach, detailed_solution, principle_to_remember (locked pedagogy fields)
                # Only update taxonomy and scoring fields
                ...
                # Fallback to basic enrichment if LLM fails (EXCLUDING locked pedagogy fields)
                # Only update answer if empty
                if not question.answer or question.answer == "To be generated by LLM":
                    question.answer = "Answer generation failed - manual review needed"
                
                # DO NOT UPDATE: solution_approach, detailed_solution (locked pedagogy fields)
                # Only update taxonomy fields
