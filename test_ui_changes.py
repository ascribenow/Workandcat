...
def test_backend_changes():
    ...
    # Test login
    login_url = "https://skill-coverage.preview.emergentagent.com/api/auth/login"
    login_data = {
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            session_url = "https://skill-coverage.preview.emergentagent.com/api/sessions/start"
            ...
            if session_response.status_code == 200:
                ...
                question_url = f"https://skill-coverage.preview.emergentagent.com/api/sessions/{session_id}/next-question"
                ...
                if question_response.status_code == 200:
                    ...
                    answer_url = f"https://skill-coverage.preview.emergentagent.com/api/sessions/{session_id}/submit-answer"
                    answer_data = {
