...
def main():
    ...
    print("1. Frontend configured: https://adapt-resume.preview.emergentagent.com")
    print("2. Review mentioned: https://adaptive-quant.emergent.host/api")
    print("=" * 80)
    
    # Test both API bases
    test_api_base("https://adapt-resume.preview.emergentagent.com/api", "FRONTEND CONFIGURED")
