...
class TwelveQuestionSessionTester:
    def __init__(self, base_url="https://twelvr-adaptive-1.preview.emergentagent.com/api"):
...
if __name__ == "__main__":
    ...
    print("Testing URL: https://twelvr-adaptive-1.preview.emergentagent.com/api")
