...
class TwelveQuestionSessionTester:
    def __init__(self, base_url="https://question-tracker-2.preview.emergentagent.com/api"):
...
if __name__ == "__main__":
    ...
    print("Testing URL: https://question-tracker-2.preview.emergentagent.com/api")
