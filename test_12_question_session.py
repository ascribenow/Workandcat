...
class TwelveQuestionSessionTester:
    def __init__(self, base_url="https://cat-mastery-system.preview.emergentagent.com/api"):
...
if __name__ == "__main__":
    ...
    print("Testing URL: https://cat-mastery-system.preview.emergentagent.com/api")
