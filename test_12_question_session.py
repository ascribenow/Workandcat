...
class TwelveQuestionSessionTester:
    def __init__(self, base_url="https://adaptive-cat-prep.preview.emergentagent.com/api"):
...
if __name__ == "__main__":
    ...
    print("Testing URL: https://adaptive-cat-prep.preview.emergentagent.com/api")
