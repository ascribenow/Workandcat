...
def test_basic_connectivity():
    ...
    try:
        response = requests.get("https://question-quality.preview.emergentagent.com/api/", timeout=10)
...
def test_admin_authentication():
    ...
    try:
        ...
        response = requests.post(
            "https://question-quality.preview.emergentagent.com/api/auth/login",
            json=login_data,
            timeout=10
        )
...
def test_llm_enrichment_priority(admin_token):
    ...
    try:
        response = requests.post(
            "https://question-quality.preview.emergentagent.com/api/questions",
            json=test_question,
            headers=headers,
            timeout=15
        )
        ...
        if response.status_code == 200:
            ...
            if status == "enrichment_queued":
                ...
                response = requests.get(
                    "https://question-quality.preview.emergentagent.com/api/questions?limit=5",
                    headers=headers,
                    timeout=10
                )
...
def test_session_engine_priority(student_token):
    ...
    try:
        ...
        for i in range(3):
            ...
            response = requests.post(
                "https://question-quality.preview.emergentagent.com/api/sessions/start",
                json=session_data,
                headers=headers,
                timeout=15
            )
...
def test_canonical_taxonomy_compliance(admin_token):
    ...
    try:
        ...
        response = requests.get(
            "https://question-quality.preview.emergentagent.com/api/questions?limit=50",
            headers=headers,
            timeout=10
        )
        ...
        if response.status_code == 200:
            ...
            if session_id:
                ...
                for i in range(min(5, total_questions)):
                    response = requests.get(
                        f"https://question-quality.preview.emergentagent.com/api/sessions/{session_id}/next-question",
                        headers=headers,
                        timeout=10
                    )
