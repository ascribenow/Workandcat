...
if __name__ == "__main__":
    ...
    # Run focused MCQ investigation first
    print("\n🎯 PRIORITY TEST: MCQ Options Investigation")
    print("="*60)
    ...
    # CRITICAL MCQ INVESTIGATION
    mcq_investigation_success = tester.test_mcq_options_investigation()
    
    if mcq_investigation_success:
        print("\n✅ MCQ OPTIONS INVESTIGATION COMPLETE - Backend working correctly")
        print("📋 RECOMMENDATION: Check frontend SessionSystem component for display issues")
    else:
        print("\n❌ MCQ OPTIONS INVESTIGATION FAILED - Backend issue confirmed")
        print("📋 RECOMMENDATION: Fix MCQ generation in session API endpoints")
    ...
    additional_tests = [
        ("Session Management", tester.test_session_management),
        ("Enhanced Session System", tester.test_enhanced_session_system),
        ("MCQ Generation", tester.test_mcq_generation),
        ("MCQ Options Endpoint", tester.test_mcq_options_endpoint),
    ]
    ...
    # Final summary
    print(f"\n{'='*80}")
    print("📊 MCQ INVESTIGATION SUMMARY")
    print('='*80)
    ...
    if mcq_investigation_success:
        print("\n🎯 CONCLUSION: MCQ options are being generated by backend")
        print("📋 NEXT STEPS: Investigate frontend SessionSystem component rendering")
    else:
        print("\n🎯 CONCLUSION: MCQ options not being generated by backend")
        print("📋 NEXT STEPS: Fix MCQ generation in session/next-question endpoint")